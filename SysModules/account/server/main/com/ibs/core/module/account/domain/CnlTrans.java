 ...
 */
public class CnlTrans extends BaseEntity {
	...
	private String bankReqTrnasDateString;
	private String bankReqTransTimeString;
//	private String transTimeB;
	...
	public String getBankReqTrnasDateString() {
		return bankReqTrnasDateString;
	}
	public void setBankReqTrnasDateString(String bankReqTrnasDateString) {
		this.bankReqTrnasDateString = bankReqTrnasDateString;
	}
	public String getBankReqTransTimeString() {
		return bankReqTransTimeString;
	}
	public void setBankReqTransTimeString(String bankReqTransTimeString) {
		this.bankReqTransTimeString = bankReqTransTimeString;
	}
	public String getId(){
		return id;
	}
...
//	public String getTransTimeB() {
//		return transTimeB;
//	}
//	public void setTransTimeB(String transTimeB) {
//		this.transTimeB = transTimeB;
//	}
	@Override
	public String toString() {
		return "CnlTrans [id=" + id + ", transNum=" + transNum + ", reqInnerNum=" + reqInnerNum + ", custCode="
				+ custCode + ", cnlCustCode=" + cnlCustCode + ", reqNum=" + reqNum + ", reqBatch=" + reqBatch
				+ ", stlNum=" + stlNum + ", transType=" + transType + ", transDc=" + transDc + ", transSubType="
				+ transSubType + ", transCurrency=" + transCurrency + ", transOrderNum=" + transOrderNum
				+ ", transAmount=" + transAmount + ", transStatus=" + transStatus + ", transLatestAmount="
				+ transLatestAmount + ", transDate=" + transDate + ", transTime=" + transTime + ", transComments="
				+ transComments + ", bankReqTime=" + bankReqTime + ", bankTransNum=" + bankTransNum
				+ ", bankAccepteTime=" + bankAccepteTime + ", bankReturnTime=" + bankReturnTime + ", bankReturnResult="
				+ bankReturnResult + ", bankPmtCnlType=" + bankPmtCnlType + ", bankPmtCnlCode=" + bankPmtCnlCode
				+ ", cnlCnlCode=" + cnlCnlCode + ", isinGl=" + isinGl + ", isPrinted=" + isPrinted + ", printedTime="
				+ printedTime + ", bankCreditAcntCode=" + bankCreditAcntCode + ", bankCreditName=" + bankCreditName
				+ ", bankCreditCode=" + bankCreditCode + ", bankCreditBranchName=" + bankCreditBranchName
				+ ", bankCreditBranchCode=" + bankCreditBranchCode + ", bankCreditCustName=" + bankCreditCustName
				+ ", bankCreditCardNum=" + bankCreditCardNum + ", bankDebitAcntCode=" + bankDebitAcntCode
				+ ", bankDebitName=" + bankDebitName + ", bankDebitCode=" + bankDebitCode + ", bankDebitBranchName="
				+ bankDebitBranchName + ", bankDebitBranchCode=" + bankDebitBranchCode + ", bankDebitCustName="
				+ bankDebitCustName + ", bankDebitCardNum=" + bankDebitCardNum + ", isValid=" + isValid
				+ ", createTime=" + createTime + ", updateTime=" + updateTime + ", creator=" + creator + ", updator="
				+ updator + ", bankReqTrnasDate=" + bankReqTrnasDate + ", bnakServiceFeeAct=" + bnakServiceFeeAct
				+ ", bankReqTransTime=" + bankReqTransTime + ", returnUrl=" + returnUrl + ", bnakHandlePriority="
				+ bnakHandlePriority + ", termialType=" + termialType + ", timeType=" + timeType + ", startTime="
				+ startTime + ", endTime=" + endTime + ", bankReqTrnasDateString=" + bankReqTrnasDateString
				+ ", bankReqTransTimeString=" + bankReqTransTimeString + ", inglTime=" + inglTime + "]";
	}
