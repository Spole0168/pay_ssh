 ...
 */
public class CnlTrans3m extends BaseEntity {
	...
	private String strBankReqTrnasDate;
	private String strBankReqTransTime;
	
	public String getStrBankReqTrnasDate() {
		return strBankReqTrnasDate;
	}
	public void setStrBankReqTrnasDate(String strBankReqTrnasDate) {
		this.strBankReqTrnasDate = strBankReqTrnasDate;
	}
	public String getStrBankReqTransTime() {
		return strBankReqTransTime;
	}
	public void setStrBankReqTransTime(String strBankReqTransTime) {
		this.strBankReqTransTime = strBankReqTransTime;
	}
	public String getId(){
		return id;
	}
