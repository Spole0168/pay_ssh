 ...
 */
public class CnlTransErr extends BaseEntity {
	...
	private String fixReqNum; // FIX_REQ_NUM
	...
	private Date reconTime; // RECON_TIME
	...
	public String getFixReqNum(){
		return fixReqNum;
	}
	public void setFixReqNum(String fixReqNum){
		this.fixReqNum = fixReqNum;
	}
