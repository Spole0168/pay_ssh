		...
		$(gridVar).jqGrid({
		    ...
		    gridComplete: function(){
                ...
                for(var i=0;i<ids.length;i++){
                    var id = ids[i];
                    modifyButton = "<a onclick='window.location.href=\"" + simpleGrid.modifyUrl + "?id=" + id + "\"' href=\"#\"><span class=\"l-btn-left\"><span class=\"l-btn-text icon-edit\">"+modifyButtonText+"</span></span></a>";
		...
		$(gridVar).jqGrid({
		    ...
		    gridComplete: function(){
                ...
                for(var i=0;i<ids.length;i++){
                	...
                	allButton = "<a onclick='window.location.href=\"" + simpleGrid.modifyUrl + "?id=" + id + "\"' href=\"#\"><span class=\"l-btn-left\"><span class=\"l-btn-text icon-edit\">"+modifyButtonText+"</span></span></a>";
                    ...
                    if(endTime != null){
                    	if(endTime.length < 2){
	                    	if(simpleGrid.adjButtonText!=null){
	                    		adjButton = "<a onclick='window.location.href=\"" + simpleGrid.adjUrl + "?id=" + id + "\"' href=\"#\"><span class=\"l-btn-left\"><span class=\"l-btn-text icon-edit\">"+simpleGrid.adjButtonText+"</span></span></a>";
	                    	}
                    ...
                    if(status != null){
                    	if(status.length > 0 && status == "2"){
                    		if(simpleGrid.auditButtonText!=null){
                    			auditButton = "<a onclick='window.location.href=\"" + simpleGrid.auditUrl + "?id=" + id + "\"' href=\"#\"><span class=\"l-btn-left\"><span class=\"l-btn-text icon-edit\">"+simpleGrid.auditButtonText+"</span></span></a>";
                        		allButton = allButton + auditButton;
                    		}
                    	}else if(status.length > 0 && status == "4"){
                    		if(simpleGrid.revokeButtonText!=null){
                    			revokeButton = "<a onclick='window.location.href=\"" + simpleGrid.revokeUrl + "?id=" + id + "\"' href=\"#\"><span class=\"l-btn-left\"><span class=\"l-btn-text icon-edit\">"+simpleGrid.revokeButtonText+"</span></span></a>";
