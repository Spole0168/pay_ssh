...
<s:if test=" searchFromWhere=='fromMDM' ">	 
<app:isPermission resource='O_MDM_ORG_DICT_MDM_MODIFY'>
<script type="text/javascript" charset="UTF-8">
    $("#canModifyData").val('true'); 
</script>
</app:isPermission>
...
<s:if test=" searchFromWhere=='fromMDM' ">	
<app:isPermission resource='O_MDM_ORG_DICT_MDM_ADD'>

 <a id="create" class="l-btn-plain l-btn m-l4" ><span class="l-btn-left"><span class="l-btn-text icon-add">新 增</span></span></a>  

</app:isPermission>

<app:isPermission resource='O_MDM_ORG_DICT_MDM_DEL'>
...
var array = new Array();
	$().ready(function() {
		...
		//	exportColNames:[ '代码', '名 称', '类型','语言','显示顺序','描述'],
		//	exportColModels:[ 'id', 'name', 'typeName', 'locale.name', 'displayOrder', 'remark'],
