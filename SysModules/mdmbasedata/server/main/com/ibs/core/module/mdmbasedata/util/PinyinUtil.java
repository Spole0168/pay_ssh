package com.ibs.core.module.mdmbasedata.util;
...
public class PinyinUtil {
		     ...
		     public static void main(String[] args) {  
		         System.out.println(stringArrayToString(stringToPinyin("长沙我se 心长")));  
		         System.out.println(charToPinyin(("长".toCharArray())[0], true, ","));
		     }  
