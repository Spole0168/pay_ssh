 ...
 * @created by	: sicon
 * @version 	: 1.0
 * @comments	: code generated based on database T_SYS_EMAIL_HIS_HIS
 * @modify		: your comments goes here (author,date,reason).
 */
public class SysEmailHisHis extends BaseEntity {
	
	private String id; // ID
	private String tsid; // T_S_ID
	private String tsid2; // T_S_ID2
	...
	public String getTsid2(){
		return tsid2;
	}
	public void setTsid2(String tsid2){
		this.tsid2 = tsid2;
	}
