...
$().ready(function() {
	...
	/* $("#cnlReqTransEditForm").validate({
		rules: {
			...
			"cnlReqTrans.msgTime": {required: true,stringMaxLength:11,isLegal: true},
			"cnlReqTrans.recieveTime": {required: true,stringMaxLength:11,isLegal: true},
			"cnlReqTrans.handleTime": {required: true,stringMaxLength:11,isLegal: true},
			...
			"cnlReqTrans.createTime": {required: true,stringMaxLength:11,isLegal: true},
			"cnlReqTrans.updateTime": {required: true,stringMaxLength:11,isLegal: true},
					...
					<form id="validate_form">
						...
						<table cellpadding="0" cellspacing="0" class="table_form">
							...
							<tr>
								...
								<td><input name="cnlReqTrans.msgTime" id="msgTime" class="width_c" value="${cnlReqTrans.msgTime}" maxlength="225"/></td>
							</tr>
							<tr>
								<th><em>*</em>${app:i18n('cnlReqTrans.recieveTime') }：</th>
								<td><input name="cnlReqTrans.recieveTime" id="recieveTime" class="width_c" value="${cnlReqTrans.recieveTime}" maxlength="225"/></td>
							</tr>
							<tr>
								<th><em>*</em>${app:i18n('cnlReqTrans.handleTime') }：</th>
								<td><input name="cnlReqTrans.handleTime" id="handleTime" class="width_c" value="${cnlReqTrans.handleTime}" maxlength="225"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input name="cnlReqTrans.createTime" id="createTime" class="width_c" value="${cnlReqTrans.createTime}" maxlength="225"/></td>
							</tr>
							<tr>
								<th><em>*</em>${app:i18n('cnlReqTrans.updateTime') }：</th>
								<td><input name="cnlReqTrans.updateTime" id="updateTime" class="width_c" value="${cnlReqTrans.updateTime}" maxlength="225"/></td>
							</tr>
							<tr>
								<th><em>*</em>${app:i18n('cnlReqTrans.creator') }：</th>
								<td><input name="cnlReqTrans.creator" id="creator" class="width_c" value="${cnlReqTrans.creator}" maxlength="225"/></td>
							</tr>
							<tr>
