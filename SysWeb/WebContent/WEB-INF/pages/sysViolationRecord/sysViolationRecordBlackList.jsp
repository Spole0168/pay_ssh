...
<script type="text/javascript" charset="UTF-8">
		...
		// 黑名单查询 
		var exportUrl = "sysViolationRecordBlackListSearch.action";
...
/* 		$("#gridTable").gridUtil().customizeColumn();
	...
	function doSearch(){
		...
		setQueryConditionBlack();
		
		$("#gridTable").jqGrid("setGridParam",{page:1});
		//获取到对应的时间来源

		$("#gridTable").jqGrid("setGridParam",{url:"sysViolationRecordBlackListSearch.action"}).trigger("reloadGrid");
	}
	function setQueryConditionBlack(){
		// 设置查询参数
...
<input type="hidden" id="searchUrl2" value="sysViolationRecordBlackListSearch.action"/>
<input type="hidden" id="searchUrl3" value="sysViolationRecordOverSpendSearch.action"/>
...
<div class="layout">
	<div class="block m-b" >
		...
		<div class="warning" style="display: none;">
					...
					<table cellpadding="0" cellspacing="0" class="table_form">
						...
						<tbody>
							<tr>
								...
								<option value="02">黑名单</option></select></td>
			...
			<div class="block"  name="blackList"  id="one">
				<div id="blackList">
					<table id="gridTable">
					</table>
