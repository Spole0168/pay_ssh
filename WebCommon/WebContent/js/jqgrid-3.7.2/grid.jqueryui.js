...
$.jgrid.extend({
    ...
    columnChooser : function(opts,array,simpleGrid) {
        var self = this;
            ...
            "apply_perm" : function() {
                $('option',select).each(function(i) {
                    if (this.selected) {
                        ...
                        var las =  JSON.stringify(colModel[this.value]);
                        //������ʾ�Զ�����
                        if(array !== null){
                        	array.push(las);	
                        }
                	...
                	//ajax�ύ
                if(array !== null){
                	var data ="field = ["+escape(array.toString())+"]" +
                	"&jqgrid="+simpleGrid.gridflag+"_"+simpleGrid.gridName;
        	array.length = 0;
        	$.ajax({
        		type:"POST",
        		url:"../jqGridAction.action",
        		data:data,
        		async:false
        	});
                }
